          ...
          <div className='w-full max-w-3xl'>
             {
                loading ? (
                    loadingCart.map((el, index) =>{
                        return(
                            <div key={el+ "Add to cart loading"+index} className='w-full bg-slate-200 h-32 my-2 border-slate-300 animate-pulse rounded'></div>
                        )
                    })
                     ...
                     return(
                        <div key={product?._id+ "Add to cart loading"} className='w-full bg-white h-32 my-2
                           ...
                           <div className='w-32 h-32 bg-slate-200'>
                            ...
                            <div className='absolute right-0 text-red-600 rounded-full p-1 hover:bg-red-600 hover:text-white cursor-pointer' onClick={() => deleteCartProduct(product?._id)}>
                                <MdDelete/>
                            </div>
                             ...
                             <div className='flex items-center justify-between'>
                              ...
                              <p className='text-slate-600 font-medium text-lg'>{displayCurrency(product?.productId.price)}</p>
                             </div>
