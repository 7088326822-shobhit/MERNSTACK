...
const VerticalProduct = ({loading, data = []}) => {
  ...
  return (
    <div className='grid grid-cols-[repeat(auto-fit,minmax(360px,320px))] justify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-none transition-all'>
