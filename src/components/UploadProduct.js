...
const UploadProduct = ({
    ...
    const handleSubmitProduct = async(e) => {
      ...
      const response = await fetch(SummaryApi.uploadController.url,{
        method: SummaryApi.uploadController.method,
        credentials: 'include',
        headers : {
  ...
  return (
    <div className='fixed w-full h-full bg-slate-200 bg-opacity-35 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            ...
            <form className='grid p-4 gap-3 overflow-y-scroll h-full pb-5' onSubmit={handleSubmitProduct}>
                        ...
                        <div className='flex items-center gap-2'>
                          {
                            ...
                            return (
                              ...
                              <div className='absolute bottom-0 right-0
                               p-1 text-white bg-red-600 rounded-full
                                hidden group-hover:block' onClick={() => handleDeleteProductImage(index)}>
                                <MdDelete/>
                              </div>
                        </div>
